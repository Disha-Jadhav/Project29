...
function setup()
{
    ...
    ground2 = new ground(850, 670, 600, 200);

    box1 = new box(700, 600, 100, 100);
    box2 = new box(800, 600, 100, 100);
    box3 = new box(900, 600, 100, 100);
    box4 = new box(1000, 600, 100, 100);

    box11 = new box(750, 450, 100, 100);
    box12 = new box(850, 450, 100, 100);
    box13 = new box(950, 450, 100, 100);

    box21 = new box(800, 300, 100, 100);
    box22 = new box(900, 300, 100, 100);

    box31 = new box(850, 200, 100, 100);
